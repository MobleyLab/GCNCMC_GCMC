...
#simulation.reporters.append(DCDReporter('3rlr-prod.dcd', 100))  
...
trj = grand.utils.shift_ghost_waters(ghost_file='3rlr-prod.txt',
                                     topology='3rlr-ghosts.pdb',
                                     trajectory='3rlr-prod.dcd')
...
grand.utils.align_traj(t=trj, output='3rlr-gcmc-md.dcd')

# Write out a PDB trajectory of the GCMC sphere
grand.utils.write_sphere_traj(radius=5.5,
                              ref_atoms=ref_atoms,
                              topology='3rlr-ghosts.pdb',
                              trajectory='3rlr-gcmc-md.dcd',
                              output='gcmc_sphere.pdb',
                              initial_frame=True)

# Cluster water sites
grand.utils.cluster_waters(topology='3rlr-ghosts.pdb',
                           trajectory='3rlr-gcmc-md.dcd',
                           sphere_radius=5.5,
                           ref_atoms=ref_atoms,
                           cutoff=2.4,
