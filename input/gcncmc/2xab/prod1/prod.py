...
trj = grand.utils.shift_ghost_waters(ghost_file='2xab-prod.txt',
                                     topology='2xab-ghosts.pdb',
                                     trajectory='2xab-prod.dcd')
...
grand.utils.align_traj(t=trj, output='2xab-gcmc-md.dcd')

# Write out a PDB trajectory of the GCMC sphere
grand.utils.write_sphere_traj(radius=5.5,
                              ref_atoms=ref_atoms,
                              topology='2xab-ghosts.pdb',
                              trajectory='2xab-gcmc-md.dcd',
                              output='gcmc_sphere.pdb',
                              initial_frame=True)

# Cluster water sites
grand.utils.cluster_waters(topology='2xab-ghosts.pdb',
                           trajectory='2xab-gcmc-md.dcd',
                           sphere_radius=5.5,
                           ref_atoms=ref_atoms,
                           cutoff=2.4,
