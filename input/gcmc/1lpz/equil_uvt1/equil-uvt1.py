...
ref_atoms = [{'name': 'CA', 'resname': 'TRP', 'resid': '258'},{'name': 'CA', 'resname': 'ILE', 'resid': '270'}]
...
gcmc_mover = grand.samplers.StandardGCMCSphereSampler(system=system,
                                                      ...
                                                      log='1lpz-equil-uvt1.log',
                                                      excessChemicalPotential=-6.09*kilocalorie_per_mole,
                                                      standardVolume=30.345*angstroms**3,
                                                      ghostFile='1lpz-uvt1-ghosts.txt',
                                                      dcd='1lpz-equil-uvt1.dcd',
                                                      rst='1lpz-equil-uvt1.rst7',
                                                      overwrite=True)
