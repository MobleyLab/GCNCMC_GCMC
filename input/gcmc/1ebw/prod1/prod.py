...
#simulation.reporters.append(DCDReporter('1ebw-prod.dcd', 100))  
...
trj = grand.utils.shift_ghost_waters(ghost_file='1ebw-prod.txt',
                                     topology='1ebw-ghosts.pdb',
                                     trajectory='1ebw-prod.dcd')
...
grand.utils.align_traj(t=trj, output='1ebw-gcmc-md.dcd')

# Write out a PDB trajectory of the GCMC sphere
grand.utils.write_sphere_traj(radius=5.5,
                              ref_atoms=ref_atoms,
                              topology='1ebw-ghosts.pdb',
                              trajectory='1ebw-gcmc-md.dcd',
                              output='gcmc_sphere.pdb',
                              initial_frame=True)

# Cluster water sites
grand.utils.cluster_waters(topology='1ebw-ghosts.pdb',
                           trajectory='1ebw-gcmc-md.dcd',
                           sphere_radius=5.5,
                           ref_atoms=ref_atoms,
                           cutoff=2.4,
