...
ref_atoms = [{'name': 'CA', 'resname': 'GLY', 'resid': '49','chain':0},{'name': 'CA', 'resname': 'GLY', 'resid': '148','chain':1}]
...
gcmc_mover = grand.samplers.StandardGCMCSphereSampler(system=system,
                                                      ...
                                                      log='1ebw-equil-uvt1.log',
                                                      excessChemicalPotential=-6.34*kilocalorie_per_mole,
                                                      standardVolume=29.823*angstroms**3,
                                                      ghostFile='1ebw-uvt1-ghosts.txt',
                                                      dcd='1ebw-equil-uvt1.dcd',
                                                      rst='1ebw-equil-uvt1.rst7',
                                                      overwrite=True)
