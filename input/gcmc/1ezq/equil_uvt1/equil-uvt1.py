...
gcmc_mover = grand.samplers.StandardGCMCSphereSampler(system=system,
                                                      ...
                                                      temperature=292*kelvin,
                                                      referenceAtoms=ref_atoms,
                                                      sphereRadius=4.2*angstroms,
                                                      log='1ezq-equil-uvt1.log',
                                                      excessChemicalPotential=-6.09*kilocalorie_per_mole,
                                                      standardVolume=30.345*angstroms**3,
                                                      ghostFile='1ezq-uvt1-ghosts.txt',
                                                      dcd='1ezq-equil-uvt1.dcd',
                                                      rst='1ezq-equil-uvt1.rst7',
                                                      overwrite=True)

# Define integrator
integrator = BAOABIntegrator(292*kelvin, 1.0/picosecond, 0.002*picosecond)
...
simulation.context.setVelocitiesToTemperature(292*kelvin)
