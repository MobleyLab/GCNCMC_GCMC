...
# Load PDB
pdb = PDBFile('1ec1-npt.pdb')
structure = pmd.load_file('1ec1-npt.pdb')
...
gcmc_mover = grand.samplers.StandardGCMCSphereSampler(system=system,
                                                      ...
                                                      log='1ec1-equil-uvt2.log',
                                                      excessChemicalPotential=-6.34*kilocalorie_per_mole,
                                                      standardVolume=29.823*angstroms**3,
                                                      ghostFile='1ec1-uvt2-ghosts.txt',
                                                      dcd='1ec1-equil-uvt2.dcd',
                                                      rst='1ec1-equil-uvt2.rst7',
                                                      overwrite=True)
